...
export const BudgetPlanner = () => {
    ...
    return (
        <div className='w-full p-4'>
            ...
            <div className='budget w-full flex justify-between items-center mt-6 mb-3 px-8'>

                <h2 className='text-2xl font-semibold min-h-12 flex justify-center items-center w-1/5 bg-gray-200 text-teal-500 rounded-md'>Budget: Rs.{budget}</h2>
